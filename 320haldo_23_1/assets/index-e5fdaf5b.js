(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function e(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=e(o);fetch(o.href,a)}})();function b(){}function H(n){return n()}function w(){return Object.create(null)}function M(n){n.forEach(H)}function K(n){return typeof n=="function"}function F(n,t){return n!=n?t==t:n!==t||n&&typeof n=="object"||typeof n=="function"}function W(n){return Object.keys(n).length===0}function i(n,t){n.appendChild(t)}function J(n,t,e){n.insertBefore(t,e||null)}function j(n){n.parentNode&&n.parentNode.removeChild(n)}function m(n){return document.createElement(n)}function Q(n){return document.createTextNode(n)}function p(){return Q(" ")}function d(n,t,e){e==null?n.removeAttribute(t):n.getAttribute(t)!==e&&n.setAttribute(t,e)}function X(n){return Array.from(n.childNodes)}function P(n,t,e,r){e===null?n.style.removeProperty(t):n.style.setProperty(t,e,r?"important":"")}let G;function N(n){G=n}const y=[],$=[];let T=[];const q=[],tt=Promise.resolve();let Z=!1;function nt(){Z||(Z=!0,tt.then(V))}function C(n){T.push(n)}const k=new Set;let I=0;function V(){if(I!==0)return;const n=G;do{try{for(;I<y.length;){const t=y[I];I++,N(t),et(t.$$)}}catch(t){throw y.length=0,I=0,t}for(N(null),y.length=0,I=0;$.length;)$.pop()();for(let t=0;t<T.length;t+=1){const e=T[t];k.has(e)||(k.add(e),e())}T.length=0}while(y.length);for(;q.length;)q.pop()();Z=!1,k.clear(),N(n)}function et(n){if(n.fragment!==null){n.update(),M(n.before_update);const t=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,t),n.after_update.forEach(C)}}function ot(n){const t=[],e=[];T.forEach(r=>n.indexOf(r)===-1?t.push(r):e.push(r)),e.forEach(r=>r()),T=t}const it=new Set;function rt(n,t){n&&n.i&&(it.delete(n),n.i(t))}function lt(n,t,e,r){const{fragment:o,after_update:a}=n.$$;o&&o.m(t,e),r||C(()=>{const s=n.$$.on_mount.map(H).filter(K);n.$$.on_destroy?n.$$.on_destroy.push(...s):M(s),n.$$.on_mount=[]}),a.forEach(C)}function at(n,t){const e=n.$$;e.fragment!==null&&(ot(e.after_update),M(e.on_destroy),e.fragment&&e.fragment.d(t),e.on_destroy=e.fragment=null,e.ctx=[])}function dt(n,t){n.$$.dirty[0]===-1&&(y.push(n),nt(),n.$$.dirty.fill(0)),n.$$.dirty[t/31|0]|=1<<t%31}function st(n,t,e,r,o,a,s,v=[-1]){const g=G;N(n);const l=n.$$={fragment:null,ctx:[],props:a,update:b,not_equal:o,bound:w(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(g?g.$$.context:[])),callbacks:w(),dirty:v,skip_bound:!1,root:t.target||g.$$.root};s&&s(l.root);let f=!1;if(l.ctx=e?e(n,t.props||{},(c,_,...u)=>{const O=u.length?u[0]:_;return l.ctx&&o(l.ctx[c],l.ctx[c]=O)&&(!l.skip_bound&&l.bound[c]&&l.bound[c](O),f&&dt(n,c)),_}):[],l.update(),f=!0,M(l.before_update),l.fragment=r?r(l.ctx):!1,t.target){if(t.hydrate){const c=X(t.target);l.fragment&&l.fragment.l(c),c.forEach(j)}else l.fragment&&l.fragment.c();t.intro&&rt(n.$$.fragment),lt(n,t.target,t.anchor,t.customElement),V()}N(g)}class mt{$destroy(){at(this,1),this.$destroy=b}$on(t,e){if(!K(e))return b;const r=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return r.push(e),()=>{const o=r.indexOf(e);o!==-1&&r.splice(o,1)}}$set(t){this.$$set&&!W(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function ct(n){let t,e,r,o,a,s,v,g,l,f,c,_,u,O,E,h,x,R,D,S,L,B,U,A;return{c(){t=m("main"),e=m("div"),e.textContent="BugApp319v02_s002 20:23:03:19:12:04",r=p(),o=m("div"),o.textContent="??? APPLIC_AZIONE",a=p(),s=m("div"),s.textContent="??? test",v=p(),g=m("script"),g.textContent=`let NodoText = "NodoText BugApp319v02_s002 20:23:03:19:12:04";
   ...
   let AltezzaPrimoPiano   = AltezzaApplicazione_Rem;
	...
	.hack_script{display:none;}`,c=p(),_=m("div"),u=m("input"),O=m("datalist"),E=m("option"),h=m("option"),x=p(),R=m("link"),D=p(),S=m("link"),L=p(),B=m("link"),U=p(),A=m("link"),P(e,"position","fixed"),P(e,"bottom","0rem"),P(e,"left","25%"),P(e,"background-color","red"),P(e,"color","white"),P(e,"font-size","75%"),d(o,"id","APPLIC_AZIONE"),d(s,"id","test"),P(s,"display","none"),d(u,"type","range"),d(u,"step","1"),d(u,"min","1"),d(u,"max","2"),E.__value="1",E.value=E.__value,h.__value="2",h.value=h.__value,d(_,"class","hack_script"),d(R,"rel","preconnect"),d(R,"href","https://fonts.gstatic.com"),d(S,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),d(S,"rel","stylesheet"),d(B,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),d(B,"rel","stylesheet"),d(A,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),d(A,"rel","stylesheet"),d(t,"id","MAIN")},m(z,Y){J(z,t,Y),i(t,e),i(t,r),i(t,o),i(t,a),i(t,s),i(t,v),i(t,g),i(t,l),i(t,f),i(t,c),i(t,_),i(_,u),i(_,O),i(O,E),i(O,h),i(t,x),i(t,R),i(t,D),i(t,S),i(t,L),i(t,B),i(t,U),i(t,A)},p:b,i:b,o:b,d(z){z&&j(t)}}}class ut extends mt{constructor(t){super(),st(this,t,null,ct,F,{})}}new ut({target:document.getElementById("app")});
