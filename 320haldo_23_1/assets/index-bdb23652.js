...
//alert("Interno compilatore Svelte TextNodo= "+TextNodo);
   ...
   let AltezzaPrimoPiano   = AltezzaApplicazione_Rem;
	...
	.hack_script{display:none;}`,c=p(),_=m("div"),u=m("input"),O=m("datalist"),T=m("option"),E=m("option"),G=p(),R=m("link"),D=p(),S=m("link"),L=p(),B=m("link"),U=p(),A=m("link"),N(e,"position","fixed"),N(e,"bottom","0rem"),N(e,"left","25%"),N(e,"font-size","75%"),d(o,"id","APPLIC_AZIONE"),d(s,"id","test"),N(s,"display","none"),d(u,"type","range"),d(u,"step","1"),d(u,"min","1"),d(u,"max","2"),T.__value="1",T.value=T.__value,E.__value="2",E.value=E.__value,d(_,"class","hack_script"),d(R,"rel","preconnect"),d(R,"href","https://fonts.gstatic.com"),d(S,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),d(S,"rel","stylesheet"),d(B,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),d(B,"rel","stylesheet"),d(A,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),d(A,"rel","stylesheet"),d(t,"id","MAIN")},m(z,Y){J(z,t,Y),i(t,e),i(t,r),i(t,o),i(t,a),i(t,s),i(t,v),i(t,g),i(t,l),i(t,P),i(t,c),i(t,_),i(_,u),i(_,O),i(O,T),i(O,E),i(t,G),i(t,R),i(t,D),i(t,S),i(t,L),i(t,B),i(t,U),i(t,A)},p:y,i:y,o:y,d(z){z&&j(t)}}}class ut extends mt{constructor(t){super(),st(this,t,null,ct,F,{})}}new ut({target:document.getElementById("app")});
