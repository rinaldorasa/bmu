...
LarghezzaPrimoPiano = LarghezzaBody_Rem ;
	...
	// 		alert("App323v10_renamed 20:23:03:23:07:14 debug TESTAPP ok!");
	}; // TESTAPP
	...
	.hack_script{display:none;}`,l=O(),p=m("div"),d=m("input"),P=m("datalist"),g=m("option"),_=m("option"),Z=O(),h=m("link"),C=O(),v=m("link"),G=O(),R=m("link"),D=O(),S=m("link"),f(e,"position","fixed"),f(e,"bottom","0rem"),f(e,"left","5rem"),f(e,"background-color","red"),f(e,"color","white"),f(e,"font-size","75%"),s(o,"id","APPLIC_AZIONE"),s(d,"type","range"),s(d,"step","1"),s(d,"min","1"),s(d,"max","2"),g.__value="1",g.value=g.__value,_.__value="2",_.value=_.__value,s(p,"class","hack_script"),s(h,"rel","preconnect"),s(h,"href","https://fonts.gstatic.com"),s(v,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),s(v,"rel","stylesheet"),s(R,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),s(R,"rel","stylesheet"),s(S,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),s(S,"rel","stylesheet"),s(n,"id","MAIN")},m(B,j){F(B,n,j),r(n,e),r(n,i),r(n,o),r(n,a),r(n,c),r(n,E),r(n,u),r(n,l),r(n,p),r(p,d),r(p,P),r(P,g),r(P,_),r(n,Z),r(n,h),r(n,C),r(n,v),r(n,G),r(n,R),r(n,D),r(n,S)},p:T,i:T,o:T,d(B){B&&H(n)}}}class mt extends dt{constructor(n){super(),at(this,n,null,st,V,{})}}new mt({target:document.getElementById("app")});
