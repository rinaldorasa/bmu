(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&i(u)}).observe(document,{childList:!0,subtree:!0});function e(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=e(o);fetch(o.href,a)}})();function y(){}function $(t){return t()}function w(){return Object.create(null)}function S(t){t.forEach($)}function q(t){return typeof t=="function"}function j(t,n){return t!=t?n==n:t!==n||t&&typeof t=="object"||typeof t=="function"}function F(t){return Object.keys(t).length===0}function r(t,n){t.appendChild(n)}function W(t,n,e){t.insertBefore(n,e||null)}function H(t){t.parentNode&&t.parentNode.removeChild(t)}function m(t){return document.createElement(t)}function Y(t){return document.createTextNode(t)}function O(){return Y(" ")}function s(t,n,e){e==null?t.removeAttribute(n):t.getAttribute(n)!==e&&t.setAttribute(n,e)}function J(t){return Array.from(t.childNodes)}function f(t,n,e,i){e===null?t.style.removeProperty(n):t.style.setProperty(n,e,i?"important":"")}let x;function h(t){x=t}const T=[],D=[];let b=[];const U=[],Q=Promise.resolve();let M=!1;function X(){M||(M=!0,Q.then(K))}function k(t){b.push(t)}const B=new Set;let I=0;function K(){if(I!==0)return;const t=x;do{try{for(;I<T.length;){const n=T[I];I++,h(n),tt(n.$$)}}catch(n){throw T.length=0,I=0,n}for(h(null),T.length=0,I=0;D.length;)D.pop()();for(let n=0;n<b.length;n+=1){const e=b[n];B.has(e)||(B.add(e),e())}b.length=0}while(T.length);for(;U.length;)U.pop()();M=!1,B.clear(),h(t)}function tt(t){if(t.fragment!==null){t.update(),S(t.before_update);const n=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,n),t.after_update.forEach(k)}}function nt(t){const n=[],e=[];b.forEach(i=>t.indexOf(i)===-1?n.push(i):e.push(i)),e.forEach(i=>i()),b=n}const et=new Set;function ot(t,n){t&&t.i&&(et.delete(t),t.i(n))}function it(t,n,e,i){const{fragment:o,after_update:a}=t.$$;o&&o.m(n,e),i||k(()=>{const u=t.$$.on_mount.map($).filter(q);t.$$.on_destroy?t.$$.on_destroy.push(...u):S(u),t.$$.on_mount=[]}),a.forEach(k)}function rt(t,n){const e=t.$$;e.fragment!==null&&(nt(e.after_update),S(e.on_destroy),e.fragment&&e.fragment.d(n),e.on_destroy=e.fragment=null,e.ctx=[])}function lt(t,n){t.$$.dirty[0]===-1&&(T.push(t),X(),t.$$.dirty.fill(0)),t.$$.dirty[n/31|0]|=1<<n%31}function at(t,n,e,i,o,a,u,N=[-1]){const p=x;h(t);const l=t.$$={fragment:null,ctx:[],props:a,update:y,not_equal:o,bound:w(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(n.context||(p?p.$$.context:[])),callbacks:w(),dirty:N,skip_bound:!1,root:n.target||p.$$.root};u&&u(l.root);let c=!1;if(l.ctx=e?e(t,n.props||{},(d,P,...g)=>{const _=g.length?g[0]:P;return l.ctx&&o(l.ctx[d],l.ctx[d]=_)&&(!l.skip_bound&&l.bound[d]&&l.bound[d](_),c&&lt(t,d)),P}):[],l.update(),c=!0,S(l.before_update),l.fragment=i?i(l.ctx):!1,n.target){if(n.hydrate){const d=J(n.target);l.fragment&&l.fragment.l(d),d.forEach(H)}else l.fragment&&l.fragment.c();n.intro&&ot(t.$$.fragment),it(t,n.target,n.anchor,n.customElement),K()}h(p)}class dt{$destroy(){rt(this,1),this.$destroy=y}$on(n,e){if(!q(e))return y;const i=this.$$.callbacks[n]||(this.$$.callbacks[n]=[]);return i.push(e),()=>{const o=i.indexOf(e);o!==-1&&i.splice(o,1)}}$set(n){this.$$set&&!F(n)&&(this.$$.skip_bound=!0,this.$$set(n),this.$$.skip_bound=!1)}}function st(t){let n,e,i,o,a,u,N,p,l,c,d,P,g,_,L,E,C,v,Z,R,G,z;return{c(){n=m("main"),e=m("div"),e.innerHTML='<div style="text-align:center;">App322v10_renamed 20:23:03:22:19:25</div>',i=O(),o=m("div"),o.textContent="??? APPLIC_AZIONE",a=O(),u=m("script"),u.textContent=`let NodoText = "NodoText App322v10_renamed 20:23:03:22:19:25";
	let TextNodo = "TextNodo App322v10_renamed 20:23:03:22:19:25";
...
\`
				...
				Circa 159.000.000 risultati (0,29 secondi) 
				...
				Mauris gravida semper erat vel bibendum. Fusce suscipit ...
				עברית
				Lorem Ipsum. "Neque porro quisquam est qui dolorem ...
				Altri risultati in lipsum.com »
				Le persone hanno chiesto anche
				Cosa vuol dire Lorem ipsum?
				Come scrivere Lorem ipsum?
				Feedback
				
				Lorem ipsum - Wikipedia
				wikipedia.org
				https://it.wikipedia.org › wiki › Lorem_ipsum
				Con il termine lorem ipsum si indica un testo segnaposto utilizzato da grafici, progettisti, programmatori e tipografi a modo riempitivo per bozzetti e ...
‎				Standard · ‎Originale · ‎Note
				
				Generatore di Testo Lorem Ipsum e di Supercazzola - Neting
				neting.it
				https://www.neting.it › Tools
				La caratteristica del testo Lorem Ipsum è quello di fornire una distribuzione delle lettere uniforme, apparendo come un normale blocco di testo leggibile. Di ...
				...
				liae.it
				https://www.liae.it
				Lorem Ipsum è un' agenzia letteraria, capace di unire la competenza nella gestione della carriera di un autore alla comprensione profonda di cosa sia e di ...
				
				Lorem ipsum dolor sit amet, consectetur. - Inprinting
				inprinting.net
				https://inprinting.net › lorem-ipsum-dolor-sit-amet-co...
				Inizia così uno dei testi più famosi del mondo che, nonostante la sua diffusione e l'immediata riconoscibilità, non vuol dire un bel niente. Lorem ipsum ...
				
				Text Generator Online Lorem Ipsum
				loremipzum.com
				https://www.loremipzum.com › generatore-testo
				Usa lorem ipsum text generator per creare il tuo testo! Il generatore di testo online Lorem Ipsum crea testo di riempimento, fittizio, finto, ...
				
				Lorem ipsum in Vocabolario - Treccani
				treccani.it
				https://www.treccani.it › lorem-ipsum_(Neologismi)
				(Lorem Ipsum, lorem ipsum) loc. s.le m. inv. Testo campione privo di significato usato da grafici, programmatori, redattori e tipografi per occupare lo spazio ...
				Ricerche correlate
				lorem ipsum text copy
				lorem ipsum generator
				lorem ipsum dolor sit amet
				lorem ipsum traduzione
				lorem ipsum dolor sit amet, consectetur adipiscing elit
				lorem ipsum cicerone
				lorem ipsum dolor sit amet traduzione
				lorem ipsum agenzia
					1	
				2
				...
				Avanti
				Risultati immagini per lorem ipsum
				Risultati immagini per lorem ipsum
				Risultati immagini per lorem ipsum
				Risultati immagini per lorem ipsum
				Risultati immagini per lorem ipsum
				Altre immagini
				Lorem ipsum
				Con il termine lorem ipsum si indica un testo segnaposto utilizzato da grafici, progettisti, programmatori e tipografi a modo riempitivo per bozzetti e prove grafiche. Wikipedia
				Feedback
				Italia
				Venezia Mestre, Venezia VE
				- In base alla tua attività passata
				- Aggiorna posizione
				GuidaInvia feedbackPrivacyTermini
...
LarghezzaPrimoPiano = LarghezzaBody_Rem ;
	...
	// 		alert("App322v10_renamed 20:23:03:22:19:25 debug TESTAPP ok!");
	}; // TESTAPP
	...
	// 	alert("2023:03:16:09:35 svelte compiled ok!");`,N=O(),p=m("style"),p.textContent=`main{
	...
	.hack_script{display:none;}`,l=O(),c=m("div"),d=m("input"),P=m("datalist"),g=m("option"),_=m("option"),L=O(),E=m("link"),C=O(),v=m("link"),Z=O(),R=m("link"),G=O(),z=m("link"),f(e,"position","fixed"),f(e,"bottom","0rem"),f(e,"left","5rem"),f(e,"background-color","red"),f(e,"color","white"),f(e,"font-size","75%"),s(o,"id","APPLIC_AZIONE"),s(d,"type","range"),s(d,"step","1"),s(d,"min","1"),s(d,"max","2"),g.__value="1",g.value=g.__value,_.__value="2",_.value=_.__value,s(c,"class","hack_script"),s(E,"rel","preconnect"),s(E,"href","https://fonts.gstatic.com"),s(v,"href","https://fonts.googleapis.com/css2?family=PT+Mono&display=swap"),s(v,"rel","stylesheet"),s(R,"href","https://fonts.googleapis.com/css2?family=Rasa&display=swap"),s(R,"rel","stylesheet"),s(z,"href","https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap"),s(z,"rel","stylesheet"),s(n,"id","MAIN")},m(A,V){W(A,n,V),r(n,e),r(n,i),r(n,o),r(n,a),r(n,u),r(n,N),r(n,p),r(n,l),r(n,c),r(c,d),r(c,P),r(P,g),r(P,_),r(n,L),r(n,E),r(n,C),r(n,v),r(n,Z),r(n,R),r(n,G),r(n,z)},p:y,i:y,o:y,d(A){A&&H(n)}}}class mt extends dt{constructor(n){super(),at(this,n,null,st,j,{})}}new mt({target:document.getElementById("app")});
