...
<TITLE> *# blocchetto_AREA_20211218_1915A.php </TITLE>
...
<form  action="blocchetto_AREA_20211218_1915A.php" method = "get">
         Riempi in dettaglio: 
         <br />
...
<div><A HREF="notes.html" class="bg-success text-light"> VEDI NOTES </A></div>
...
$txt = $txt ."\r\n"  . '<body id="BODY" class="m-0">';
$txt = $txt ."\r\n"  . '<main id="MAIN" class="mx-1">';
$txt = $txt ."\r\n"  . '<A HREF="blocchetto_AREA_20211218_1915A.php">AGGIORNA IL NOTES</A><BR>';
