...
LarghezzaPrimoPiano = LarghezzaBody_Rem ;
	...
	<div id="BUONGIORNO" style="padding-top:0.50rem;  display:block;">
		...
		<div id="OGGI">
			<div style="padding:\`+(MargineSinistra_Rem*0.5)+\`rem;border:dashed 0.5rem rgba(252,78,5,0.5);">
	...
	// 		alert("App324cv10_attivato 20:23:03:24:12:19 debug TESTAPP ok!");
	}; // TESTAPP
